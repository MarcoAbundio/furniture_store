package com.furniturestore.employee.exception;
...
public class GlobalExceptionHandler {
    ...
    public record ErrorResponse(int status, String message, LocalDateTime timestamp, Map<String, String> errors) {
        static ErrorResponse of(int s, String m) { return new ErrorResponse(s, m, LocalDateTime.now(), null); }
        static ErrorResponse ofValidation(Map<String, String> e) { return new ErrorResponse(400, "Validation failed", LocalDateTime.now(), e); }
    }
}
